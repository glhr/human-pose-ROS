...
cmPoint get_skeleton_point_3d(rs2::depth_frame const &depthFrame, int x, int y)
{
    ...
    // for (int i = 0; i < 5; i++)
    // {
    //     std::cout << intr.coeffs[i] << std::endl;
    // }
    
    
    // std::cout << intr.fx << std::endl;
    // std::cout << intr.fy << std::endl;
    // std::cout << intr.height << std::endl;
    // std::cout << intr.width << std::endl;
    // std::cout << intr.ppx << std::endl;
    // std::cout << intr.ppy << std::endl;
    // std::cout << typeid(intr.model).name() << std::endl;
...
*/
inline void renderSkeletons(const CM_SKEL_Buffer *skeletons_buffer, rs2::depth_frame const &depth_frame, cv::Mat &image, ros::Publisher skeleton_pub, float *r, float *g, float *b){
